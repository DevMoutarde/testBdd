...
namespace Proxies\__CG__\ADMC\CoreBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \ADMC\CoreBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'ADMC\\CoreBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'ADMC\\CoreBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'ADMC\\CoreBundle\\Entity\\User' . "\0" . 'prenom');
        }
